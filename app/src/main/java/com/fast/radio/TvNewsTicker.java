...
public class TvNewsTicker {
    ...
    private List<String> readFeed(String feed)throws Exception{
        ArrayList<String> out=new ArrayList<>(); URL u=new URL(feed); HttpURLConnection c=(HttpURLConnection)u.openConnection();c.setConnectTimeout(7000);c.setReadTimeout(10000);c.setRequestProperty("User-Agent","Fast Radio/4.8");InputStream in=c.getInputStream();
