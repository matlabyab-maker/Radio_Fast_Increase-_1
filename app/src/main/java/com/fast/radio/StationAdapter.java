...
public class StationAdapter extends BaseAdapter {
    ...
    @Override public View getView(int p, View convert, ViewGroup parent){
        ...
        Button open=new Button(context); open.setText("↗"); open.setTextSize(18); open.setContentDescription("Open stream in another player"); row.addView(open,new LinearLayout.LayoutParams(54,54));
        ...
        star.setOnClickListener(v->{listener.favorite(s); notifyDataSetChanged();});
        return row;
    }
}
