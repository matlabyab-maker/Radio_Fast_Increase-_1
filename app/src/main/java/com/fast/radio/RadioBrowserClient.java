...
public class RadioBrowserClient {
    ...
    public static void byCountry(String code,StationCallback cb){ request("/json/stations/bycountrycodeexact/"+Uri.encode(code)+"?hidebroken=true&order=votes&reverse=true&limit=500",cb); }
